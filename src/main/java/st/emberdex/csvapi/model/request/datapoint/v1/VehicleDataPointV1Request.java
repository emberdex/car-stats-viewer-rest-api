package st.emberdex.csvapi.model.request.datapoint.v1;
...
import st.emberdex.csvapi.model.VehicleDataPointV1;
...
/**
 * Data point request for application versions which don't use API versioning (the "V1" API)
 */
@Data
@Builder
@NoArgsConstructor
...
public class VehicleDataPointV1Request extends VehicleDataPointRequest {
  ...
  public VehicleDataPoint toDataPoint() {
    VehicleDataPointV1 dataPoint = new VehicleDataPointV1();
